...
const TestimonialsCol = (props: { col: typeof testimonials }) => {
  return (
    <div className="ml-5 hidden md:block">
      {props.col.map((testimonial) => (
...
<section>
    ...
    <TestimonialsCol col={firstcol} />
    <TestimonialsCol col={secondcol} />
    <TestimonialsCol col={thirdcol} />
